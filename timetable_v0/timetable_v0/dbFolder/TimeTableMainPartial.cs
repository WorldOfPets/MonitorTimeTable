     ...
     public partial class TimeTableMain
    {
        ...
        public string Back
        {
            get
            {
                ...
                if ((/*(now.Hour == 20) ||*/ (now.Hour == 9 && now.Minute > 0) || (now.Hour == 10 && now.Minute < 30)) && Number == 1) { return "#3A5199"; } 
        ...
        public string getVis
        {
            get
            {
                ...
                else if (((/*(now.Hour == 20)||*/(now.Hour == 9 && now.Minute > 0) || (now.Hour == 10 && now.Minute < 30)) && Number == 1) || (((now.Hour == 20) || (now.Hour == 9 && now.Minute > 0) || (now.Hour == 10 && now.Minute < 30)) && Number == 2)) { return "Visible"; }
        ...
        public string Fore
        {
            ...
            {
                var now = DateTime.Now;
                if ((/*(now.Hour == 20) ||*/ (now.Hour == 9 && now.Minute > 0) || (now.Hour == 10 && now.Minute < 30)) && Number == 1) { return "#D5D6D2"; }
